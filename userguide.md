...
sequences to another view (`:mv`). Switching views clears the current selection.
...
you will reject or move; Shift-Up/Down and Shift-Left/Right scroll the view by
half-screen without changing the selection.
