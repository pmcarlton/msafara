...
> 
* [ ] Check all links on github, drop any refs to SIB Gitlab.
...
* [ ] Note this at least on the GitHub page, possibly also in the manuscript.
> 
...
I have not noticed any performance hit due to this, but this could be done.
...
* [ ] Try to fix this, if only by padding trailing positions with gaps.
> 
> 3. Practically everyone will want a '/' search command !
> 
Agreed - this is in fact already on my TODO list, but for the next release as it
will entail significant extra code to read a search pattern, move between
...
* [ ] Check the download links. Note that Rev #1 _built_ the binary, so it could
  be that the Crates.io links are ok while the download ones are not.
...
* [ ] Fix this, at least in the README. 
