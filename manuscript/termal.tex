...
\begin{abstract} \textbf{Summary:} We present \texttt{termal}, a fast,
	...
	\url{https://github.com/sib-swiss/termal.git}
...
\texttt{termal} and \texttt{alen} are written in Rust and compile to a single
binary with no dependencies. By contrast, \texttt{alv} requires BioPython and
\texttt{showalign} is part of the EMBOSS suite.
...
more traditional emulators, and terminals that support 24-bit colours give
better results. 
\texttt{termal} is currently restricted to Fasta-formatted alignments.
